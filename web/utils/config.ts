    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "string", name: "imageDataUrl", type: "string" },
          { internalType: "string", name: "message", type: "string" },
          { internalType: "string", name: "signedBy", type: "string" },
          { internalType: "address", name: "mintedBy", type: "address" },
          { internalType: "bool", name: "isUnwrapped", type: "bool" },
          { internalType: "bool", name: "isBurnt", type: "bool" },
